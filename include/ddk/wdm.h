...
typedef void (WINAPI *PDRIVER_ADDDEVICE)(struct _DRIVER_OBJECT *, struct _DEVICE_OBJECT *);
...
NTSTATUS  WINAPI IoRegisterDeviceInterface(PDEVICE_OBJECT,GUID*,PUNICODE_STRING,PUNICODE_STRING);
